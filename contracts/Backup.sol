...
//     }
    ...
    // ) public {
    //     uint256 sl_id = totalMlResultStored;
    //     mlResults[totalMlResultStored] = mlResult(
    //         sl_id,
    //         result,
    //         vulscore,
    //         nonvulscore,
    ...
    //     totalMlResultStored = totalMlResultStored + 1;
    // }

    // //get result from ML to UI

    // function getResults(uint256 sl_id)
    //     public
    //     view
    //     returns (
    //         uint256,
    ...
    //     )
    // {
    //     mlResult memory mlr = mlResults[sl_id];
    //     return (
    //         mlr.serial_no,
    //         mlr.result,
    //         mlr.vulscore,
    ...
    // // function to send back ml result to ui
    // function getAllMlResult(uint256 sl_id)
    //     public
    //     view
    //     returns (
    //         uint256,
    ...
    //     )
    // {
    //     mlResult memory mr = mlResults[sl_id];
    //     return (
    //         mr.serial_no,
    //         mr.result,
    //         mr.vulscore,
    ...
    //     mlResult[] memory details = new mlResult[](totalMlResultStored);
    //     for (uint256 i = 0; i < totalMlResultStored; i++) {
    //         details[i] = mlResults[i];
    //     }
    //     return details;
    // }
